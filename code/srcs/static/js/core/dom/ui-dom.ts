...
export function getUIElements(): UIElements {
  ...
  return {
    pages: {
      ...
      tron: get<HTMLElement>("pagesTron", "Pages"),
    ...
    controlsModal: {
      ...
      inputLeftLeft: get<HTMLInputElement>("key-left-left", "ControlsModal"),
      inputLeftRight: get<HTMLInputElement>("key-left-right", "ControlsModal"),
      ...
      inputRightLeft: get<HTMLInputElement>("key-right-left", "ControlsModal"),
      inputRightRight: get<HTMLInputElement>("key-right-right", "ControlsModal"),
